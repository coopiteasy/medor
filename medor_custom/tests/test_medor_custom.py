        ...
        user_1 = User.create(
            {
                "login": "user_" + "1",
                "partner_id": self.ref(
                    "product_subscription.demo_subscriber_1"
                ),
            }
        )
        user_2 = User.create(
            {
                "login": "user_" + "2",
                "partner_id": self.ref(
                    "product_subscription.demo_subscriber_2"
                ),
            }
        )
        user_3 = User.create(
            {
                "login": "user_" + "3",
                "partner_id": self.ref(
                    "product_subscription.demo_subscriber_3"
                ),
            }
        )
        user_4 = User.create(
            {
                "login": "user_" + "4",
                "partner_id": self.ref(
                    "product_subscription.demo_subscriber_4"
                ),
            }
        )
        user_5 = User.create(
